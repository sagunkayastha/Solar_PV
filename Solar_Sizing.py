...
import p4_Block_battery
from p2_usable_storage import peak_sun,Ah_load,battery
from tkinter import*
from other_data import Pv_char
import tkinter.messagebox as ts
#Ah_load=147
#peak_sun=3.1
print(battery)
tk6=Tk()
ce,df=DoubleVar(),DoubleVar()
pvmod=PhotoImage(file='images/Pv_modules.gif')
photo1=PhotoImage(file='images/Pv_1st.gif')
photo2=PhotoImage(file='images/Pv_1.gif')
photo3=PhotoImage(file='images/Pv_2stup.gif')
photo4=PhotoImage(file='images/Pv_2stdown.gif')
photo5=PhotoImage(file='images/Pv_midup.gif')
photo6=PhotoImage(file='images/Pv_middown.gif')
